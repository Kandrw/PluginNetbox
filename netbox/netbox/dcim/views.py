...
@register_model_view(DeviceType, 'opticcable', path='optic-cable')
class DeviceTypeOpticCable(DeviceTypeComponentsView):
    ...
    viewname = 'dcim:devicetype_consoleserverports'
    tab = ViewTab(
        label=_('Type3 optic cable'),
        badge=lambda obj: obj.console_server_port_template_count,
        permission='dcim.view_opticcable',
        weight=790,
        hide_if_empty=True
    )
...
@register_model_view(ModuleType, 'opticcable', path='optic-cable')
class ModuleOpticCable(ModuleTypeComponentsView):
    child_model = ConsoleServerPortTemplate
    table = tables.ConsoleServerPortTemplateTable
    filterset = filtersets.ConsoleServerPortTemplateFilterSet
    viewname = 'dcim:moduletype_consoleserverports'
    tab = ViewTab(
        label=_('Type2 optic cable'),
        badge=lambda obj: obj.consoleserverporttemplates.count(),
        permission='dcim.view_opticcable',
        weight=780,
        hide_if_empty=True
...
@register_model_view(Device, 'opticcable', path='optic-cable')
class DeviceOpticCable(DeviceComponentsView):
    child_model = ConsoleServerPort
    table = tables.DeviceConsoleServerPortTable
    filterset = filtersets.ConsoleServerPortFilterSet
    filterset_form = forms.ConsoleServerPortFilterForm
